...
export class UserComponent implements OnInit {
  ...
  public tableConfig: ITableConfig = {
    columnDefinition: [
      new IndexColumn('index', '#', 5, false, true),
      new TextColumn('customer_id_format', 'ID', 10, false, undefined, true),
      new TextColumn('customer_name', 'Name', 10, true, 'above', true),
      new TextColumn('representative_post_code', 'Post Code', 20, false, undefined, undefined, true),
      new TextColumn('mail', 'E-mail', 20),
      new TextColumn('phone_number', 'Phone Number', 30, true, 'below'),
      new OptionButtonColumn(this.options, 5)
    ]
  };
